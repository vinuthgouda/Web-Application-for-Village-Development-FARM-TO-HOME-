      ...
      <div class="large-12">
		...
		<table id="myTable" class="table table-active">
			<tr class="header">
				...
				<th style="width:60%;">Date of Order</th>
				<th style="width:60%;">Place Shipment</th>
				
			</tr>
  
        <?php
          $user = $_SESSION["username"];
          $result = $mysqli->query('SELECT * FROM orders where status=0');
          if($result) {
            while($obj = $result->fetch_object()) {
			  ...
			  echo '<td><a href="sendShipment.php?id=' .$obj->id. '"><button>Ship Now</button></a>';
			  echo '</td>';
